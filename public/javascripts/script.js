...
// ************ les probabilité aprés l'event du button  ************
...
$('#buttonR').click(function() {
 ...
 var dropdown4 = $('#salaire').val();
          ...
          if (dropdown1 == 'Bac' && dropdown3 == dropdown3 && dropdown4 == '(20K€-25K€)') {
            $("#resultat1").modal('show');
            // $('#modal2').hide();
            // $('#modal3').hide();
          }
          if (dropdown1 == 'Bac' && dropdown3 == dropdown3) {
            $("#resultat1").modal('show');
            // $('#modal2').hide();
            // $('#modal3').hide();
          }
          if (dropdown1 == 'Bac' && dropdown3 == '' && dropdown2 == '' && dropdown4 == '') {
            $("#resultat1").modal('show');
            // $('#modal2').hide();
            // $('#modal3').hide();
          }
          ...
          if (dropdown1 == 'BTS' && dropdown3 == dropdown3 && dropdown2 == dropdown2 && dropdown4 == dropdown4) {
            $("#resultat2").modal('show');
            $('#modal2').show();
            $('#modal3').hide();
          }
          if (dropdown1 == 'BTS' && dropdown3 == '' && dropdown2 == '' && dropdown4 == '') {
            $("#resultat2").modal('show');
            $('#modal2').show();
            $('#modal3').hide();
          }

          if (dropdown1 == 'Bac + 4' && dropdown4 == '(35K€-40K€)' && dropdown3 == dropdown3 && dropdown2 == dropdown2) {
            $("#resultat3").modal('show');
          }

          if (dropdown1 == 'Bac + 4' && dropdown3 == '' && dropdown2 == '' && dropdown4 == dropdown4) {
            $("#resultat3").modal('show');
          }
